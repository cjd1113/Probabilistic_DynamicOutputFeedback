...
%% THIS SCRIPT IS FOR THE SHRINK REDUCED CASE %%
...
%%%%%%ADJUST THIS PATH%%%%%%%%%
cd '/Users/christopherdangelo/Dropbox/Research/Probabilistic Decentralized Robust Active Structural Control/Genetic Algorithms/FinalFunctionsforSupercomputing/SupercomputerResults/2'
...
coupledsystem = loopformulations_silent(beammodel_1,beammodel_2,Controller1nom,Controller2nom,coupling,'scenario_5');
...
cd '/Users/christopherdangelo/Dropbox/Research/Probabilistic Decentralized Robust Active Structural Control/GeneticAlgorithms/FinalFunctionsforSuperComputing/SuperComputerResults/shrinkreduced/Figures'

figname = sprintf('GASolutionShrinkRed_Case%d',Case);
